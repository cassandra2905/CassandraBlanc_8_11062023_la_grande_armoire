...
<head>
    ...
    <link rel="stylesheet" href="./css/politique_confidentialite.css">
...
<body>
    ...
    <main>
        <h2>La Grande Armoire</h2>

        <h3>Politique de confidentialité</h3>

        <p class="introductory-sentence">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>

        <section class="container-privacy-policy-paragraph">
