<div class="before-footer">
    <div class="container-before-footer">
        <nav>
            <h4>Nos sorties</h4>
            <p>Rendez-vous sur nos réseaux sociaux pour découvrir en temps réel les pièces présentes dans notre summer pop-up.</p>
            <ul class="before-footer-social-network">
                <li>
